...
public class DishAdapter extends BaseAdapter {
    ...
    public DishAdapter(Context context, List<Product> productList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_management_dish, parent, false);
        }
    ...
    // Hàm để xóa một sản phẩm từ danh sách và cập nhật giao diện
